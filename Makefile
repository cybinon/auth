...
FLAGS=-ldflags "-X github.com/cybinon/auth/internal/utilities.Version=`git describe --tags`" -buildvcs=false
ifdef RELEASE_VERSION
	FLAGS=-ldflags "-X github.com/cybinon/auth/internal/utilities.Version=v$(RELEASE_VERSION)" -buildvcs=false
endif
